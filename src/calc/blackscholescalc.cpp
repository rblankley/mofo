...
#include "common.h"
#include "blackscholescalc.h"

#include "util/blackscholes.h"
#include "util/newtonraphson.h"

///////////////////////////////////////////////////////////////////////////////////////////////////
BlackScholesCalculator::BlackScholesCalculator( double underlying, const table_model_type *chains, item_model_type *results ) :
...
///////////////////////////////////////////////////////////////////////////////////////////////////
double BlackScholesCalculator::calcImplVol( AbstractOptionPricing *pricing, OptionType type, double X, double price, bool *okay ) const
{
    return NewtonRaphson::calcImplVol( pricing, type, X, price, okay );
}

///////////////////////////////////////////////////////////////////////////////////////////////////
AbstractOptionPricing *BlackScholesCalculator::createPricingMethod( double S, double r, double b, double sigma, double T, bool european ) const
{
    Q_UNUSED( european )
