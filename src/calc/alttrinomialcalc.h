/**
 * @file alttrinomialcalc.h
 * Alternative Trinomial tree based option profit calculator.
 *
...
#ifndef ALTTRINOMIALCALC_H
#define ALTTRINOMIALCALC_H
...
/// Alternative Trinomial tree based option profit calculator.
class AlternativeTrinomialCalculator : public ExpectedValueCalculator
{
    using _Myt = AlternativeTrinomialCalculator;
...
public:
     ...
     */
    AlternativeTrinomialCalculator( double underlying, const table_model_type *chains, item_model_type *results );

    /// Destructor.
    ~AlternativeTrinomialCalculator();
...
private:
    ...
    // not implemented
    AlternativeTrinomialCalculator( const _Myt& ) = delete;
