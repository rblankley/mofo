...
///////////////////////////////////////////////////////////////////////////////////////////////////
AbstractOptionPricing *TrinomialCalculator::createPricingMethod( double S, double r, double b, double sigma, double T, const std::vector<double>& divTimes, const std::vector<double>& divYields, bool european ) const
{
    Q_UNUSED( divTimes )
    Q_UNUSED( divYields )
